 ...
 */
public class ToAssignedContractServlet extends HttpServlet{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (userId == null) {
			...
			try {
				...
				List<ConDistribute> conDistributeList = new ArrayList<ConDistribute>();
				// Call business logic layer to get list of contract to be countersigned 
				conDistributeList = contractService.getConDistributeList();
